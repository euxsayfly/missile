function dy = dynamics1(~,y)
% y(1) = xm; y(2) = ym; y(3) = zm;
% y(4) = Vm; y(5) = psim; y(6) = gammam; V为速度，psi为弹道偏角，gamma为弹道倾角
% y(7) = belta; y(8) = epsilon;
% y(9) = xt; y(10) = yt; y(11) = zt;
%y(12) = Vt; y(13) = psit; y(14) = gammat;
...
dxt = y(12) * cos(y(14)) * cos(y(13));
dyt = y(12) * cos(y(14)) * sin(y(13)); 
dzt = y(12) * sin(y(14));%目标运动学方程
...
dvm  =  g * (nx - sin(y(6)));
dpsim =  g * nmy / (y(4) * cos(y(6)));
dgammam =  g / y(4) * (nmp - cos(y(6)));%导弹动力学方程

dvt = g * (ntx - sin(y(14)));
dpsit = g / y(12) * (ntz * cos(mut) - cos(y(14)));
dgammat = g / (y(12) * cos(y(14))) * ntz * sin(mut);%无人机动力学方程
